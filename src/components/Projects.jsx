...
const Projects = () => {
  ...
  const test4 = document.querySelector("#overlay-intersector4");
  ...
  useEffect(() => {
    ...
    const observer4 = new IntersectionObserver((entries, observer) => {
      entries.forEach((entry) => {
        if (entry.isIntersecting) {
          $("#mycha-overlay").addClass("overlay-transform-right");
        }
      });
    });
        ...
        <a href="/mycha">
          ...
          >
            ...
            <div
              ...
              id="overlay-intersector4"
            />

            <img
              src="https://cdn.discordapp.com/attachments/779278654714675232/1039110818433867836/image.png"
              style={{
                width: "100%",
                height: "100%",
                objectFit: "cover",
            ...
            <div
              className="view-project-button4"
              style={{
                userSelect: "none",
              }}
              id="mycha-view-but"
